...
namespace RimBees
{
    public class WorkGiver_TakeThingsOutOfAdvancedBeehouse : WorkGiver_Scanner
    {
        public override ThingRequest PotentialWorkThingRequest
        {
            get
            {
                return ThingRequest.ForDef(DefDatabase<ThingDef>.GetNamed("RB_AdvancedBeehouse", true));
            }
        }
